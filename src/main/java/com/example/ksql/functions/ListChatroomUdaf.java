...
public final class ListChatroomUdaf {
    ...
    public static TableUdaf<Struct, List<Struct>, List<Struct>> listChatroom() {

        return new TableUdaf<Struct, List<Struct>, List<Struct>>() {
            ...
            @Override
            public List<Struct> undo(final Struct valueToUndo,
                               final List<Struct> aggregate) {
                return aggregate;
            }
        };
    }
